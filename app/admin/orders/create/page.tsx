...
import { Loader2, Plus, ShoppingBag, Trash2, Undo2, Redo2, Ticket, Check, UserPlus } from 'lucide-react';
...
export default function CreateOrderPage() {
  ...
  return (
    <AdminFormPageWrapper
      ...
      subtitle="Tạo đơn hàng nhanh cho khách mua trực tiếp hoặc online"
      ...
      stickyFooter={
        <AdminStickyFooter
          ...
          disableSave={isSubmitting || items.length === 0}
        />
      }
      extraHeaderAction={
            ...
            <Card className="border border-slate-200/80 shadow-sm dark:border-slate-800">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                ...
                <Button
                  ...
                  className="h-8 text-xs flex items-center gap-1 border-blue-600/30 text-blue-600 hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-blue-950/20"
                >
                  <UserPlus size={14} />
              ...
              <CardContent>
                <div ref={customerContainerRef} className="relative">
                  <Input
                    ...
                    className="w-full pl-3 pr-10 focus-visible:ring-blue-500"
                  />
                  {customerId && (
                    <span className="absolute right-3 top-1/2 -translate-y-1/2 flex h-5 w-5 items-center justify-center rounded-full bg-blue-100 text-blue-600 dark:bg-blue-950/30 dark:text-blue-400">
                      <Check size={12} />
                    </span>
                  )}
                  {isCustomerDropdownOpen && (
            ...
            <Card className="border border-slate-200/80 shadow-sm dark:border-slate-800">
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                          ...
                          searchedProducts.map(p => (
                            ...
                            >
                              ...
                              <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 flex items-center justify-between">
                                <span>SKU: {p.sku}</span>
                                <span className="font-medium text-blue-600 dark:text-blue-400">{formatPrice(p.salePrice ?? p.price)}</span>
                              </div>
                            </button>
                          ))
                        )}
                  ...
                  <Input
                    type="number"
                    className="w-20 focus-visible:ring-blue-500"
                    min={1}
                    value={quantity}
                    ...
                    {items.map((item, index) => (
                      <div key={index} className="flex items-center justify-between p-3.5 hover:bg-slate-50/50 dark:hover:bg-slate-800/10">
                        <div className="flex-1">
                          ...
                          {item.variantTitle && (
                            <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mt-0.5">Biến thể: {item.variantTitle}</p>
                          )}
                        ...
                        <div className="flex items-center gap-3">
                          <Input
                            type="number"
                            className="w-16 h-8 text-center focus-visible:ring-blue-500"
                            min={1}
                            value={item.quantity}
              ...
              <Card className="border border-slate-200/80 shadow-sm dark:border-slate-800">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <textarea
                      id="shipping-address"
                      className="w-full rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-sm min-h-[80px] focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:text-slate-100"
          ...
          <div className="space-y-6">
            ...
            {enabledFields.has('paymentMethod') && (
              <Card className="border border-slate-200/80 shadow-sm dark:border-slate-800">
                ...
                <CardContent>
                  <select
                    className="w-full h-10 rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-500/20 dark:text-slate-100"
                    value={paymentMethod}
            ...
            <Card className="border border-slate-200/80 shadow-sm dark:border-slate-800">
              ...
              <CardContent className="space-y-3">
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    <Input
                      ...
                      className="uppercase font-medium focus-visible:ring-blue-500"
                    />
                ...
                {appliedPromo && (
                  <div className="flex items-center justify-between text-xs bg-blue-50 dark:bg-blue-950/20 text-blue-700 dark:text-blue-400 px-3 py-2 rounded-md border border-blue-200/60 dark:border-blue-800/40">
              ...
              <CardContent className="space-y-3.5">
                ...
                {enabledFields.has('shippingFee') && (
                  <div className="flex justify-between items-center text-sm text-slate-600 dark:text-slate-400">
                    ...
                    <Input
                      type="number"
                      className="w-28 h-8 text-right focus-visible:ring-blue-500"
                      min={0}
                      value={shippingFee}
                ...
                <div className="border-t border-slate-200 dark:border-slate-800 pt-3.5 flex justify-between font-bold text-lg text-slate-900 dark:text-slate-100">
                  <span>Tổng tiền:</span>
                  <span className="text-blue-600 dark:text-blue-400">{formatPrice(totalAmount)}</span>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <form onSubmit={handleQuickCustomerSubmit} className="space-y-4 py-2">
            ...
            <DialogFooter className="pt-4 flex gap-2">
              ...
              <Button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white h-9 text-xs flex items-center gap-1.5"
              >
