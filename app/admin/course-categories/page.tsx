  ...
  return (
    <AdminPageLayout>
      <AdminPageHeader
        ...
        description="Quản lý phân loại khóa học"
        addHref="/admin/course-categories/create"
      />
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <SortableHeader label="Số khóa học" sortKey="count" sortConfig={sortConfig} onSort={(key) => { setSortConfig((prev) => getNextSortState(prev, key)); }} className="text-center" />
                  ...
                  <SortableTableRow key={category.id} id={category.id} disabled={!isReorderEnabled} selected={selectedIds.includes(category.id)} selectedClassName="bg-indigo-500/5">
                    ...
                    <TableCell className="text-right whitespace-nowrap">
                      <RowActions>
                        ...
                        />
                        <EditActionButton href={`/admin/course-categories/${category.id}/edit`} />
            ...
            {sortedData.length === 0 ? (
              ...
              sortedData.map(category => (
                <MobileRowCard
                  ...
                  details={<div><span className="text-slate-400">Số khóa học:</span> {category.count}</div>}
                  actions={
                    <RowActions>
                      <RowActionButton
                        title="Xem trên web"
