...
interface QuickCreateProjectCategoryModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function QuickCreateProjectCategoryModal({
  isOpen,
  onClose,
  onCreated,
}: QuickCreateProjectCategoryModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative mx-4 w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-slate-900">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Tạo danh mục dự án</h3>
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-2">
            ...
            <Input
              ...
              required
              placeholder="VD: Website, Branding, Nội thất..."
              autoFocus
            />
