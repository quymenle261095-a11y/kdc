...
import { FilterSelect, ResetFilterButton, SearchInput } from '../../components/TableUtilities';
import { AdminPagination, generatePaginationItems } from '@/app/admin/components/TableUtilities';
      ...
      <Card>
        <div className="flex flex-col gap-4 border-b border-slate-100 p-4 dark:border-slate-800 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            />
            <ResetFilterButton isFiltered={Boolean(searchTerm.trim() || status !== 'active')} onReset={handleResetFilters} />
          </div>
        </div>
