...
export default async function IntegrationPage({ params }: Props) {
  ...
  if (!page || page.landingType !== 'integration') notFound();
  ...
  const funnelLinks = getFunnelInternalLinks('integrations');
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <RelatedPagesBlock items={relatedPages} title="Tích hợp liên quan" />
